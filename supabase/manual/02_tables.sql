...
--
-- Bu dosya ne yapar?
-- Moments icin gerekli tum ana tablolari, foreign key iliskilerini ve temel unique/check kurallarini olusturur.
--
-- Ne zaman calistirilir?
-- 01_extensions.sql basariyla calistiktan sonra Supabase SQL Editor'da calistirilir.
--
