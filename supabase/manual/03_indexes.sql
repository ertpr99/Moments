...
--
-- Bu dosya ne yapar?
-- Arama, arkadaslik, chat, mesaj, Moment ve bildirim sorgulari icin gerekli indexleri olusturur.
--
-- Ne zaman calistirilir?
-- 02_tables.sql basariyla calistiktan sonra Supabase SQL Editor'da calistirilir.
--
