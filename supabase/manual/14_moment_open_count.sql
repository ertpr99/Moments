-- Moments Supabase Kurulumu - 14_moment_open_count.sql
-- Bu dosya, Momentlerin en fazla 2 defa acilabilmesi icin open_count alanini ekler.
-- Supabase SQL Editor'da 13_friend_request_repair_policy.sql dosyasindan sonra calistirilmalidir.
-- Bundan once 01-13 arasindaki dosyalar calistirilmis olmalidir.
